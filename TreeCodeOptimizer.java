...
public class TreeCodeOptimizer {
...
for(i=0;i<n;i++)
{
	System.out.print(arr[i].op);System.out.print(" ");
	System.out.print(arr[i].op1);System.out.print(" ");
	System.out.print(arr[i].op2);System.out.print(" ");
	System.out.print(arr[i].res);System.out.print(" ");
	System.out.print(arr[i].flag);System.out.print(" ");
}
sc.close();
}
...
for(i=0;i<n;i++)
{
 if(Character.isDigit(arr[i].op1[0]) && Character.isDigit(arr[i].op2[0])) //if both digits, store them in variables
 {
  ...
  // System.out.println(new String(res1)+" "+res);
   //sprintf(res1,"%d",res);   
